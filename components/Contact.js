        ...
        <div className='flex flex-col w-6/12 ml-[12rem] pt-12'>
            <div className='flex flex-row '>
                ...
                <div className='flex flex-col w-7/12'>
                    ...
                    <input 
                    className='mb-4 py-2 pl-2'/>

                    <label>Enter Your Message</label>
                    <textarea className='resize-none h-[10rem] pt-2 pl-2'></textarea>

                </div>



                <button className='mt-2 bg-[none] w-16 border-2 border-white text-white'>Send</button>
