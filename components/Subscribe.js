...
const Subscribe = () => {
  return (
    <div className='bg-black h-[30rem] flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col justify-center text-white w-4/12 text-center'>
        <label required>Enter your Email Here</label>
        <input 
        placeholder="Email"
        className='outline-white border-2 border-white mt-6 w-12/12 h-12 text-black py-[auto] pl-4'
        />
