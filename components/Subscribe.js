...
const Subscribe = () => {
  return (
    ...
    <div className='bg-black h-[30rem] flex flex-col items-center justify-center'>
        <h2 className='text-2xl lg:text-4xl text-white flex justify-center'>JOIN OUR MAILING LIST</h2>
        <h4 className='text-base lg:text-xl text-white mb-6'>And Never Miss An Update</h4>
