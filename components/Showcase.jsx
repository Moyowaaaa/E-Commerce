...
const Showcase = ({ products, loader, openStore }) => {
  return (
    <div className="     w-full">
      {products ? (
        <div className="flex flex-row justify-center flex-row my-6">
          {products &&
            products.map((product) => (
              <div
                className="w-3/12 h-[25rem] hover:border-2 border-[blue] mx-2 h-full w-full flex flex-col lg:flex-row"
                key={product.id}
              >
                <div className="w-full flex-col flex items-center justify-center cursor-pointer">
                  ...
                  >
                    <div className="flex flex-col h-3/4  py-[auto] items-center justify-center cursor-pointer">
                      ...
                      <div className="flex flex-col jusitfy-center w-full mx-[auto] items-center">
                        {product.title}
                        <br />
