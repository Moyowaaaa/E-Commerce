        ...
        <div className=' mt-4 justify-center'>
          ...
          <div className='flex-wrap flex-row flex justify-center'>
           {products && products.map(product => (
              <div className='h-[30rem]  w-[25rem] mr-6 my-6 hover:border-2 border-[blue]' key={product.id}>
                  <div className='flex flex-col h-3/4  py-[auto] items-center justify-center'><img src={product.image} height={200} width={150}/></div>
